...
const { Customer: SequelizeCustomer } = models_1.sequelize.models;
class SequelizeCustomerRepository {
    ...
    create(customerDTO) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newCustomer = yield SequelizeCustomer.create({
                name,
                cpf,
                email
            });
    ...
    findByCPF(cpf) {
        return __awaiter(this, void 0, void 0, function* () {
            const customer = yield SequelizeCustomer.findOne({
                where: { cpf: cpf }
            });
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const customer = yield SequelizeCustomer.findByPk(id);
            return __classPrivateFieldGet(this, _SequelizeCustomerRepository_instances, "m", _SequelizeCustomerRepository_createCustomerDTO).call(this, customer);
        });
    }
}
