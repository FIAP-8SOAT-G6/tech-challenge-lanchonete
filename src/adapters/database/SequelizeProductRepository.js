...
const { Product: SequelizeProduct, Image: SequelizeImage } = models_1.sequelize.models;
class SequelizeProductRepository {
    ...
    create(productDTO) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createdProduct = yield SequelizeProduct.create({
                name,
                category,
                description,
                price
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const product = yield SequelizeProduct.findByPk(id);
    ...
    update(productDTO) {
        return __awaiter(this, void 0, void 0, function* () {
            const dbProduct = yield SequelizeProduct.findByPk(productDTO.id);
...
_SequelizeProductRepository_instances = new WeakSet(), _SequelizeProductRepository_findAllProducts = function _SequelizeProductRepository_findAllProducts(conditions) {
    return __awaiter(this, void 0, void 0, function* () {
        const products = yield SequelizeProduct.findAll(conditions);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const images = yield SequelizeImage.findAll({
    ...
    return __awaiter(this, arguments, void 0, function* ({ productId, images }) {
        if (!images)
            return;
        const newImages = yield Promise.all(images.map((image) => SequelizeImage.create({
            ProductId: productId,
            url: image.url
        })));
        return newImages;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const dbImages = yield SequelizeImage.findAll({
            where: { ProductId: productId }
        });
